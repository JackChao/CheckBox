...
import com.alex.callback.SimpleAnimatorListener;
...
public class CheckBox extends View {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int size = Math.min(width - getPaddingLeft() - getPaddingRight(), height - getPaddingBottom() - getPaddingTop());
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        /*对号左边细线  起点 - x */
        pointArray[0] = 72 / 600F * size;
        /*对号左边线  起点 - y */
        pointArray[1] = 315 / 600F * size;

        /*对号左边细线 终点 - x */
        pointArray[2] = 222 / 600F * size;
        /*对号左边细线 终点 - y */
        pointArray[3] = 435 / 600F * size;

        /*对号右边细线  起点 - x */
        pointArray[4] = 222 / 600F * size;
        /*对号右边细线  起点 - y */
        pointArray[5] = 435 / 600F * size;

        /*对号右边细线  终点 - x */
        pointArray[6] = 485 / 600F * size;
        /*对号右边细线  终点 - y */
        pointArray[7] = 154 / 600F * size;
    }
